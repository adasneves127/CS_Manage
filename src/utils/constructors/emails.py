...
def password_reset_email(User) -> str:
    ...
    Welcome to {app_info['system_name']}. We have received a request to reset your password. If you did not request this, please contact your system administrator. <br/>
    To reset your password, please click the following link: <br/>
    <a href="{app_info['application_url']}/reset_password/{User.user_name}">Reset Password</a> <br/>
    ...
    <br/><br/><br/>
    This is a system-generated email. To unsubscribe, please contact your system administrator.
    """
